...
APP_IDENTITY = {
    ...
    "version": "1.0.0",
    "icon": "⚖️💻",
    "tagline": "Su Asistente Especializado en Sistema Justicia XXI Web (Tyba)",
    "full_title": "¡Bienvenido a TybaBot! ⚖️💻",
    ...
    "docs_url": "https://github.com/bladealex9848/TybaBot/blob/main/README.md",
    ...
    "repository_url": "https://github.com/bladealex9848/TybaBot",
    ...
    "short_description": "Tu asistente especializado para comprender y utilizar el Sistema de Gestión de Procesos Judiciales Justicia XXI Web (Tyba).",
    "long_description": """
    ### ⚖️💻 ¡Hola! Soy TybaBot, tu asistente especializado en el Sistema Justicia XXI Web (Tyba)

    Estoy aquí para brindarte información y apoyo sobre el Sistema de Gestión de Procesos Judiciales **Justicia XXI Web (Tyba)**, la plataforma judicial electrónica implementada gradualmente en todos los despachos y juzgados judiciales de Colombia.

    #### ¿Qué puedo hacer por ti hoy? 🤔

    * **Documentos Electrónicos Judiciales**: Explicar qué son los e-documents y cómo crearlos
    * **Actuaciones Judiciales**: Orientarte sobre el índice del expediente y sus componentes
    * **Memoriales Electrónicos**: Guiarte en la presentación de documentos posteriores a la demanda
    * **Notificaciones Electrónicas**: Informarte sobre medios autorizados y requisitos legales
    * **Firmas Electrónicas**: Explicar el sistema de firma del expediente y responsabilidades
    * **Términos y Plazos**: Aclarar reglas de recepción fuera de horario hábil
    * **Correos Institucionales**: Orientarte sobre configuración y uso autorizado
    * **Formatos y Documentos**: Proporcionar enlaces directos a formatos oficiales

    **¡No dudes en consultarme cualquier inquietud sobre el sistema TYBA!**

    *Recuerda: Proporciono información general basada en el manual de procedimientos vigente hasta agosto de 2023. Para problemas técnicos complejos o fallas del sistema, consulta al soporte técnico oficial.*
    """,
    # User instructions
    "usage_instructions": """
    1. **Consultas sobre el Sistema**: Escribe tu pregunta para recibir información sobre procedimientos, definiciones y buenas prácticas en TYBA.

    2. **Análisis de Documentos**: Comparte documentos del sistema para análisis y orientación sobre su correcta gestión.

    3. **Solicitud de Formatos**: Pídeme enlaces directos a los formatos oficiales como creación de usuarios, solicitud de correcciones, etc.

    4. **Orientación Procedimental**: Consulta sobre flujos de trabajo, términos técnicos, actuaciones judiciales y gestión de expedientes electrónicos.

    5. **Capacitación**: Obtén información para entrenamiento de nuevos usuarios o comprensión de conceptos del sistema.
    """,
    # Document processing information
    "document_processing_info": """
    Esta aplicación utiliza tecnología de procesamiento de texto para:

    - Analizar documentos relacionados con el Sistema Justicia XXI Web (Tyba)
    - Extraer información relevante de manuales, formatos y procedimientos
    - Identificar elementos clave en actuaciones judiciales y memoriales electrónicos
    - Sugerir mejores prácticas para gestión de documentos electrónicos
    ...
    **Formatos soportados**: PDF (.pdf), Texto (.txt), Imágenes (.jpg, .jpeg, .png). Otros formatos no serán procesados.
    ...
    "chat_placeholder": "¿Cómo puedo ayudarte con el Sistema Justicia XXI Web (Tyba) hoy?",
    "file_upload_default_message": "He cargado el documento '{files}' para análisis. Por favor, analiza su contenido desde la perspectiva del Sistema Justicia XXI Web (Tyba).",
    "badges": """
    ![Visitantes](https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2Ftybabot.streamlit.app&label=Visitantes&labelColor=%235d5d5d&countColor=%231e7ebf&style=flat)
    """,
    # Welcome message (displayed on first load)
    "welcome_message": """
    ### ⚖️💻 ¡Bienvenido a TybaBot!

    Soy tu asistente especializado en el **Sistema de Gestión de Procesos Judiciales Justicia XXI Web (Tyba)**. Estoy aquí para ayudarte a comprender y utilizar esta plataforma judicial electrónica implementada gradualmente en todos los despachos y juzgados de Colombia.

    * Puedo explicarte sobre documentos electrónicos judiciales y e-documents
    * Proporcionarte información sobre actuaciones judiciales y gestión de expedientes
    * Orientarte sobre memoriales electrónicos y su presentación
    * Informarte sobre notificaciones electrónicas y medios autorizados
    * Explicarte el sistema de firmas electrónicas y responsabilidades
    * Aclararte términos, plazos y reglas de recepción
    * Darte enlaces directos a formatos oficiales del sistema

    **¿En qué aspecto del sistema TYBA puedo ayudarte hoy?**
    """,
    ...
    "menu_items": {
        ...
        "Report a bug": None,
        "About": "TybaBot: Asistente especializado en Sistema Justicia XXI Web (Tyba) - Plataforma judicial electrónica del sistema judicial colombiano",
    },
    # Footer text
    "footer_text": """
    ...
    **Adaptador del Fork:**
    ...
    "document_prefix": "tybabot",
    "conversation_export_name": "tybabot_conversacion",
...
with st.sidebar:
    ...
    # Enlaces a formatos oficiales
    st.markdown("---")
    st.subheader("📋 Enlaces a Formatos Oficiales")
    
    # Crear botones para los formatos principales
    if st.button("📝 Solicitud Creación de Usuarios TYBA", key="formato_usuarios"):
        st.markdown("[Acceder al formato](https://etbcsj-my.sharepoint.com/:b:/g/personal/darbelaal_cendoj_ramajudicial_gov_co/EffUHqC2YuNJnluDGZ13qUoBFHY2jxoYDyof9Xvxr0BUtQ?e=iJc7Yy)")
    
    if st.button("🚪 Formato Cierres de Puertas para Reparto", key="formato_puertas"):
        st.markdown("[Acceder al formato](https://etbcsj-my.sharepoint.com/:b:/g/personal/darbelaal_cendoj_ramajudicial_gov_co/EVWLeyt-kFxDm5ilJ228KzMBMZvPo9GruVu0fSo_btI-bA?e=aUElsX)")
    
    if st.button("🔧 Formato Solicitud Correcciones", key="formato_correcciones"):
        st.markdown("[Acceder al formato](https://etbcsj-my.sharepoint.com/:b:/g/personal/darbelaal_cendoj_ramajudicial_gov_co/EafNJKYbxkxGmtPtQEr4sIwBMMmhonX4wdttiHhm0fdXcg?e=92ttzK)")
    
    if st.button("📊 Clasificación Procesos TYBA", key="clasificacion_procesos"):
        st.markdown("[Acceder al documento](https://etbcsj-my.sharepoint.com/:x:/g/personal/darbelaal_cendoj_ramajudicial_gov_co/EaQm15hc3-BHtgV-YzWB3foBDEOo5n4NtslGuKjdByMCRQ?e=48jCDR)")
    
    if st.button("📖 Manual Tutela Digital", key="manual_tutela"):
        st.markdown("[Acceder al manual](https://etbcsj-my.sharepoint.com/:b:/g/personal/darbelaal_cendoj_ramajudicial_gov_co/EaS77-QwjUBDmGIHXVT62AUBZyMEXoR32rVFsXPRRJ3INg?e=yeZguQ)")
    
    if st.button("📘 Manual Uso Justicia XXI Web", key="manual_uso"):
        st.markdown("[Acceder al manual](https://etbcsj-my.sharepoint.com/:b:/g/personal/darbelaal_cendoj_ramajudicial_gov_co/EaIgtJWNwgxJmLMdCKlUIfIBg7ISCbn8ifH-tcf0ghUqag?e=JVikPT)")
